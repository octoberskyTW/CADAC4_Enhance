...
///////////////////////////////////////////////////////////////////////////////
void Aircraft::vehicle_data(fstream &input)
{
...
///////////////////////////////////////////////////////////////////////////////
Packet Aircraft::loading_packet_init(int num_aircraft,int num_aim)
{
	string id;
	char object[4];
...
//010207 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
Packet Aircraft::loading_packet(int num_aircraft,int num_aim)
{
	int index(0);
	int i(0);
