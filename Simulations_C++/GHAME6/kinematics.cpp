...
//050326 Moved timing here from 'newton' module, PZi
///////////////////////////////////////////////////////////////////////////////
...
void Round6::def_kinematics()
{
	...
	round6[3].init("out_step_fact",0,"Output factor: out_step*(1+out_step_fact)","kinematics","data","");
    ...
    round6[134].init("psibd",0,"Yawing angle of veh wrt geod coord - rad","kinematics","diag","plot");
    ...
    round6[140].init("alppx",0,"Total angle of attack - deg","kinematics","out","plot");
    round6[141].init("phipx",0,"Aerodynamic roll angle - deg","kinematics","out","");
    ...
    round6[146].init("alphaix",0,"Angle of attack, inertial velocity - deg","kinematics","diag","plot");
    round6[147].init("betaix",0,"Side slip angle, inertial velocity - deg","kinematics","diag","plot");
}	
...
void Round6::kinematics(double sim_time,double event_time,double &int_step,double &out_fact)
{
	...
	//all output step sizes are changed by this factor
	...
	//note: to avoid rare errors: #IND (or NaN) of angles psibd 
	//      and phibd (acos, asin problem), cpsi and sphi are forced 
	//		to be always <= (1.-EPS)
