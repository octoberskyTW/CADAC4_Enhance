...
//      	   	               = 2 shear wind, input: waltl,dvaegl;walth,dvaedh;psiwdx
//
//030507 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
...
void Round6::def_environment()
{
	//Definition and initialization of module-variables
     round6[50].init("mair","int",0,"Switch: mair =|matmo|mturb|mwind|","environment","data","");
     ...
     round6[70].init("psiwdx",0,"Wind direction from north - deg","environment","data","");
...
//      	   	               = 2 shear wind, input: waltl,dvaegl;walth,dvaedh;psiwdx
//
// (2) Calculates the vehicles's Mach number and dynamic pressure
//     Constant horizontal wind is input by 'dvae' and wind direction 'psiwdx'
//     Shear wind is provided through low altitude input 'waltl', 'dvael'
//      and high altitude input 'walth', 'dvaeh' with fixed wind angle psiwdx.
// (3)Heat equilibrium calculations on nose of vehicle
// (4)Gravitational acceleration based on WGS84 ellipsoid
//
//030507 Created by Peter H Zipfel
