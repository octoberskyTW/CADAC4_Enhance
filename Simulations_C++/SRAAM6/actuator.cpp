...
// (3) Limits fins excursions and converts back to control deflections
//
//030607 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
...
void Missile::actuator(double int_step)
{
	...
	if(mact<2)
	{
		...
		dpx=(-delx1-delx2+delx3+delx4)/4.;
		dqx=(+delx1+delx2+delx3+delx4)/4.;
		drx=(-delx1+delx2-delx3+delx4)/4.;
	//-------------------------------------------------------------------------
